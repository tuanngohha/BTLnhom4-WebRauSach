...
class RecentPostsPlus extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => __('The most recent posts on your site. Includes advanced options.', 'functionality-for-zap-theme')
        );
        parent::__construct('recent-posts-plus', __('Zap - Recent Posts Plus', 'functionality-for-zap-theme'), $widget_ops);
    }
    ...
    function parse_output($instance) {
        ...
        if( $the_query->have_posts() ) {
            ...
            while ( $the_query->have_posts() ) { $the_query->the_post();
                ...
                if($include_post_thumbnail == "false" || get_the_post_thumbnail($ID, 'zap-small-thumbnail') == '' ) {
                    $POST_THUMBNAIL = '';
                    $extra_class = "no_thumb";
                } else {
                    $extra_class = "";
                    if ( $post_thumbnail_width ==  '' || $post_thumbnail_height == '' ) {
                        $POST_THUMBNAIL = get_the_post_thumbnail($ID, 'zap-small-thumbnail');
                    } else {
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'functionality-for-zap-theme'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('Number of posts to show:', 'functionality-for-zap-theme'); ?></label>
        ...
        <p>
            <?php if( current_theme_supports('post-thumbnails') ): ?>
                ...
                <label for="<?php echo $this->get_field_id('include_post_thumbnail'); ?>"><?php _e('Include post thumbnail', 'functionality-for-zap-theme'); ?></label><br>
            <?php endif; ?>
            ...
            <label for="<?php echo $this->get_field_id('include_post_excerpt'); ?>"><?php _e('Include post excerpt', 'functionality-for-zap-theme'); ?></label><br>
            ...
            <label for="<?php echo $this->get_field_id('show_expert_options'); ?>"><?php _e('Show expert options', 'functionality-for-zap-theme'); ?></label>
        </p>

        <div class="rpp_expert-panel" style="display:none; margin-top: 10px">

            <p>
                <label for="<?php echo $this->get_field_id('truncate_post_title'); ?>"><?php _e('Limit post title:', 'functionality-for-zap-theme'); ?></label>
                ...
                <label for="<?php echo $this->get_field_id('truncate_post_excerpt'); ?>"><?php _e('Limit post excerpt:', 'functionality-for-zap-theme'); ?></label>
                ...
                <label for="<?php echo $this->get_field_id('truncate_elipsis'); ?>"><?php _e('Limit ellipsis:', 'functionality-for-zap-theme'); ?></label>
                ...
                <label for="<?php echo $this->get_field_id('post_date_format'); ?>"><?php _e('Post date format:', 'functionality-for-zap-theme'); ?></label> <a title="View Documentation" target="_blank" href="http://www.pjgalbraith.com/2011/08/recent-posts-plus/">(?)</a>
            ...
            <?php if( current_theme_supports('post-thumbnails') ): ?>
                <p>
                    <label for="<?php echo $this->get_field_id('post_thumbnail_width'); ?>"><?php _e('Thumbnail size (WxH):', 'functionality-for-zap-theme'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('wp_query_options'); ?>"><?php _e('WP_Query Options', 'functionality-for-zap-theme'); ?></label> <a title="View Documentation" target="_blank" href="http://www.pjgalbraith.com/2011/08/recent-posts-plus/">(?)</a><br />
            ...
            <p>
                <label for="<?php echo $this->get_field_id('widget_output_template'); ?>"><?php _e('Widget Output Template', 'functionality-for-zap-theme'); ?></label> <a title="View Documentation" target="_blank" href="http://www.pjgalbraith.com/2011/08/recent-posts-plus/">(?)</a><br />
