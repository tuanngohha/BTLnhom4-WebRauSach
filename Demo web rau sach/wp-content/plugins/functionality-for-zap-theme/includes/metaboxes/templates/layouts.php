...
<div class="row-container">
	...
	<div class="content layouts">
		<?php foreach($layouts as $layout) { ?>
			...
			<label for="<?php echo $id . '-' . $layout; ?>"><img src="<?php echo ZAP_PLUGIN_URI; ?>public/images/layout-<?php echo $layout; ?>.png" alt="" class="<?php if($selected == $layout) echo 'selected'; ?>" /></label>
		<?php } ?>
	</div>
</div>